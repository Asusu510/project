...
@section('open')
    <h1 class="m-0 text-dark">Thêm mới từ khóa</h1>
@stop
@section('name')
        ...
        @csrf
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="k_name" name="k_name" value="{{ old('k_name') }}" placeholder="Nhập tên">
                    ...
                    <textarea class="form-control" id="k_description" name="k_description" rows="3" placeholder="Miêu tả"></textarea>
