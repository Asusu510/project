            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="a_name" placeholder="Nhập tên bài viết" name="a_name" value="{{ $article->a_name }}">
                    ...
                    <div class="form-group " >
                        ...
                        <textarea name="a_description" class="form-control " id="content" >{{ $article->a_description }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select name="a_menu_id" class="form-control custom-select ">
                           ...
                           @foreach($menus as $menu)
                            <option value="{{ $menu->id }}" {{ $menu->id == $article->a_menu_id ? 'selected' : '' }}>{{ $menu->mn_name }}</option>
                           @endforeach
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <div class="input-group">
                        <input type="text" class="form-control" hidden name="a_avatar" placeholder="input name" id="a_avatar" value="{{ $article->a_avatar }}">
                    ...
                    @endif                 
                    <img src="{{ url('uploads').'/'.$article->a_avatar}}" alt="" id="show_a_avatar" style="width : 100%; margin-top : 10px">
                </div>
            </div>
            <div class="card ">
                <div class="card-body">
