			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				@csrf
					...
					<div class="wrap-input100  m-b-23" >
						...
						<input class="input100" type="name" name="name" placeholder="Nhập tên của bạn">
					...
					<div class="wrap-input100  m-b-23">
						...
						<input class="input100" type="password" name="r_password" placeholder="Nhập lại mật khẩu">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
